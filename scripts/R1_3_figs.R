...
# increase the 1.3 ppm MM peaks by 150%
amp1 <- mm_exp_mod$spin_groups[[2]]$scale_factor * 2.0
amp2 <- mm_exp_mod$spin_groups[[3]]$scale_factor * 2.0
mm_exp_mod$spin_groups[[2]]$scale_factor <- amp1
mm_exp_mod$spin_groups[[3]]$scale_factor <- amp2

approx_basis_list  <- append(metab_basis_list, list(mm_exp_mod))
approx_basis <- sim_basis(approx_basis_list, pul_seq = seq_slaser_ideal,
                        xlim = c(0.5, 4.2))

fname <- "../data/R1_3_figs.rds"        # precomputed results
...
cairo_pdf("../figures/rev1_3_fig1.pdf", width = 6.92, height = 5.5)
print(full_plot)
dev.off()

tiff("../figures/rev1_3_fig1.tiff", width = 300 * 6.92, height = 300 * 5.5, res = 300)
print(full_plot)
dev.off()
...
cairo_pdf("../figures/rev1_3_fig2.pdf", width = 6.92, height = 6.5, pointsize = 10)
print(full_plot_supp)
dev.off()

tiff("../figures/rev1_3_fig2.tiff", width = 300 * 6.92, height = 300 * 6.5,
