...
fname <- "../data/fig9_S6.rds"        # precomputed results
...
cairo_pdf("../figures/figS6.pdf", width = 6.92, height = 6.5, pointsize = 10)
print(full_plot_supp)
dev.off()

tiff("../figures/figS6.tiff", width = 300 * 6.92, height = 300 * 6.5,
