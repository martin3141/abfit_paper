...
fname <- "../data/fig4_S1.rds"        # precomputed results
...
cairo_pdf("../figures/figS1.pdf", width = 6.92, height = 6.5, pointsize = 10)
print(full_plot_supp)
dev.off()

tiff("../figures/figS1.tiff", width = 300 * 6.92, height = 300 * 6.5,
