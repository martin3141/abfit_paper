...
\begin{figure}
  \begin{center}
    ...
    \caption{TODO - note the error bars are 5x the true}
    \label{mrs_bl_simple}
  \end{center}
\end{figure}
...
Figure \ref{big_broad_bl}.
Figure \ref{sim_lip_mm_basis}.
...
% state some limitations like a good scientist - eg only deals with broad baseline features
