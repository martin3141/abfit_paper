...
\begin{figure}
  \begin{center}
    ...
    \caption{ABfit result plot for a voxel within a 2D MRSI semi-LASER acquisition with an asymmetric lineshape. A) default analysis with an asymmetric lineshape fit model, B) analysis where the lineshape asymmetry parameter ($a_{g}$) is restricted to $\pm 0.0001$.}
    \label{lineshape_res}
  \end{center}
\end{figure}
