...
In the final stage of ABfit, the overall lineshape model is refined alongside minor adjustments to the frequencies and linewidths of the known basis signals. An asymmetric lineshape model is generated in the time-domain by smoothly adjusting the Gaussian linewidth parameter as a function of frequency --- as described by Stancik and Brauns \cite{Stancik2008}.
