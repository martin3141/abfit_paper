...
A new algorithm to automatically determine the correct level of baseline flexibility has been developed and validated using simulated and acquired MRS data. Other approaches...

% highlight findings and compare with LCM and other published methods

% compare with other approaches 200 words
