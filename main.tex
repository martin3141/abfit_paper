...
Using simulated data we can illustrate the relationship between $\lambda$, ED and the optimal level of smoothness. The top left panel in Figure \ref{pspline_error}A shows a simple sine function with added normally distributed noise, shown in red and black respectively. Candidate P-spline smoothers are applied to the noisy simulated data, with differing values of $\lambda$ as shown in the remaining 5 panels.
