...
The goal of this stage of the algorithm is to find estimates of the signal phase $\phi_{0}$; an approximate lineshape parameter $d_{g}$ and an improved estimate of $f_{o}$. The phase and frequency offset are applied to the acquired data as follows:

\begin{equation}
\end{equation}

where the phase parameter is measured in radians.
